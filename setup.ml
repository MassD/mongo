...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1f0c26b6644c4bc33f190bf7650c25d5) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ("mongo", OCamlbuildDocPlugin.doc_build "src");
          ("mongo_lwt", OCamlbuildDocPlugin.doc_build "lwt")
       ];
     ...
     clean_doc =
       [
          ("mongo", OCamlbuildDocPlugin.doc_clean "src");
          ("mongo_lwt", OCamlbuildDocPlugin.doc_clean "lwt")
       ];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("bson", None)];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "mongo";
                           FindlibPackage ("bson", None);
                   ...
                   {
                      lib_modules =
                        ["Mongo_lwt"; "MongoAdmin_lwt"; "MongoSend_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "mongo";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_mongo.ml"})
            ];
          plugins =
            [
               (`Extra, "META", Some "0.3");
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "roUÚèßt°ÉÞ}+ê0«Ù";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
