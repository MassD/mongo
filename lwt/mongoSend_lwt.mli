...
val send_no_reply: (Lwt_io.input_channel * Lwt_io.output_channel) -> string -> unit Lwt.t;;

(** this function will send the string and wait for a response as a MongoReply *)
val send_with_reply: (Lwt_io.input_channel * Lwt_io.output_channel) -> string -> MongoReply.t Lwt.t;;
